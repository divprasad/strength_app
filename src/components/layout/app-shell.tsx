        ...
        <div className="mx-auto max-w-6xl px-4 py-3 md:px-6 md:py-4">
          <div className="flex items-center justify-between gap-4 rounded-[1.7rem] border border-white/55 bg-card/90 px-4 py-3 shadow-[0_20px_60px_-32px_hsl(var(--foreground)/0.45)] ring-1 ring-black/5 md:px-5">
            <div className="min-w-0">
              <div className="text-[0.7rem] font-semibold uppercase tracking-[0.28em] text-primary/80">Training System</div>
              <div className="text-xl font-semibold tracking-[-0.04em] md:text-2xl">{APP_NAME}</div>
              <div className="truncate text-xs text-muted-foreground md:text-sm">Fast local workout logging for repeatable sessions</div>
            </div>
